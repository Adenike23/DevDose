  ...
  return (
    <div className='bg-gray-300'>
      <Navbar formData={formData}/>
        <form onSubmit={handleSubmit} className='bg-gray-950 text-white absolute left-[50%] top-[70%] md:top-[65%] -translate-x-[50%] -translate-y-[50%] p-10 rounded flex justify-center flex-col sm:w-[65%] md:w-[50%] xl:w-[40%]'>
            <label htmlFor="email" className='mt-5'>Email</label>
            <input type="text" onChange={handleChange} name="email" id="email" className='text-black p-2 rounded block mt-3' autoComplete='off' placeholder='email'/>
            ...
            <input type="text" onChange={handleChange} name="username" id="userName" className='text-black p-2 rounded block mt-3' autoComplete='off' placeholder='username'/>
            ...
            <input type="password" onChange={handleChange} name="confirmPassword" id="confirmPassword" className='text-black p-2 rounded block mt-3' autoComplete='off' placeholder='confirmPassword'/>
